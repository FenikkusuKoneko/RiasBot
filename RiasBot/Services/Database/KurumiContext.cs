...
{
    public class KurumiContextFactory : IDesignTimeDbContextFactory<KurumiContext>
    {
        public KurumiContext CreateDbContext(string[] args)
        {
            ...
            var ctx = new KurumiContext(optionsBuilder.Options);
            return ctx;
        }
    }
    public class KurumiContext : DbContext
    {
