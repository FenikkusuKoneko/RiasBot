...
namespace Rias.Core.Extensions
{
    public static class UserExtensions
    {
        ...
        public static string GetRealAvatarUrl(this IUser user)
        {
            return user.GetAvatarUrl(size: 2048) ?? user.GetDefaultAvatarUrl();
        }
        ...
        public static int CheckHierarchy(this SocketGuildUser currentUser, SocketGuildUser user)
            => currentUser.Hierarchy - user.Hierarchy;
