...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "patron_status", new[] { "active_patron", "declined_patron", "former_patron" });
            ...
            modelBuilder.Entity("Rias.Database.Entities.CustomCharacterEntity", b =>
                {
                    ...
                    b.HasIndex("SearchVector")
                        .HasDatabaseName("ix_custom_characters_search_vector");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("SearchVector"), "GIN");

                    b.ToTable("custom_characters", (string)null);
                });
            ...
            modelBuilder.Entity("Rias.Database.Entities.CustomWaifuEntity", b =>
                {
                    ...
                    b.ToTable("custom_waifus", (string)null);
                });
            ...
            modelBuilder.Entity("Rias.Database.Entities.GuildXpRoleEntity", b =>
                {
                    ...
                    b.ToTable("guild_xp_roles", (string)null);
                });
            ...
            modelBuilder.Entity("Rias.Database.Entities.MuteTimerEntity", b =>
                {
                    ...
                    b.ToTable("mute_timers", (string)null);
                });
            ...
            modelBuilder.Entity("Rias.Database.Entities.PatreonEntity", b =>
                {
                    ...
                    b.Property<int>("WillPayAmountCents")
                        .HasColumnType("integer")
                        .HasColumnName("will_pay_amount_cents");

                    b.HasKey("Id")
                        .HasName("pk_patreon");

                    b.HasIndex("PatreonUserId", "UserId")
                        .IsUnique()
                        .HasDatabaseName("ix_patreon_patreon_user_id_user_id");
            ...
            modelBuilder.Entity("Rias.Database.Entities.SelfAssignableRoleEntity", b =>
                {
                    ...
                    b.ToTable("self_assignable_roles", (string)null);
                });
